...
describe(`Test some functionality website chromedriver.chromium.org site`, function() {
    it(`Homework testnew test`, async () => {
...
await driver.sleep(2000);
const findFirstLinkDriver = await driver.findElement(By.css('div.DLXGJd div.gtazFe > div.vH0yjd > a[data-position="1"]')).getText();
expect(findFirstLinkDriver).contain('Getting');
await driver.sleep(2000);
await driver.close();
})
})
