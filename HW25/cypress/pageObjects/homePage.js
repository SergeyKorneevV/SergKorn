class HomePage {
    ...
    clickAndCheckFirstPartItemByNumber(number) {
        this.firstBlockItem(number)
            .click();
        this.firstBlockItem(number)
            .should('have.css', 'background-color', 'rgb(221, 221, 221)')
    }
    doubleClickFirstPartItemByNumber(number, selectedItem) {
        this.firstBlockItem(number)
            .dblclick();
    ...
    checkAllCheckboxesAndCheck() {
        this.returnCheckboxByNumber(0)
        .check()
        this.returnCheckboxByNumber(1)
        .check()
        this.returnCheckboxByNumber(2)
        .check()
        this.numberOfcheckedCheckboxes()
            .invoke('text')
            .should('equal', '3');
    ...
    mouseOverTheItemAndCheck(number, text) {
